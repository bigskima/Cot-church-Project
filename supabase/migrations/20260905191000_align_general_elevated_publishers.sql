-- Treat any active feed.post assignment in the church as elevated publishing
-- authority for General Community. This keeps branch-scoped Expression Admin
-- roles aligned with the mobile effective-permission model.
