...
Deno.serve(createHandler(
  ...
  async ({ request, auth }) => {
    ...
    const pastoralSafetyInstruction = memberConcern.urgentSafety
      ? (urgentAlert?.routed
        ? "The member's latest message contains explicit first-person safety-risk language. A restricted pastoral safety alert has been created and routed to the pastoral team assigned to the exact current church/Expression scope. Respond with calm, compassionate language; encourage the member to stay with a trusted person and contact local emergency or crisis services if danger is immediate; include 1-3 relevant Scripture references without inventing verse wording; and clearly tell the member that COT AI sent the restricted alert because the message suggested immediate safety risk."
        : "The member's latest message contains explicit first-person safety-risk language. A restricted pastoral safety alert has been recorded, but no pastoral recipient is currently assigned in this exact scope. Respond with calm, compassionate language; tell the member that the alert was recorded but may not have reached a pastor yet; strongly encourage them to stay with a trusted person and contact local emergency or crisis services if danger is immediate; and include 1-3 relevant Scripture references without inventing verse wording.")
