...
const checks = [
  ...
  [/title="Public posting"[\s\S]*Open[\s\S]*Paused[\s\S]*Approved accounts only/, 'Moderation workspace exposes three clear General posting modes'],
  [/Approved public posters[\s\S]*Find an account to approve[\s\S]*add_public_posting_exemption/, 'Moderation workspace manages explicit public posting approvals'],
  ...
  [/restrict_posting[\s\S]*restore_posting/, 'Account governance retains individual posting suspension controls'],
