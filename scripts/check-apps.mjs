...
const checks = [
  ...
  [/Deletion history[\s\S]*Retry cleanup[\s\S]*retry_storage_cleanup/, 'Deletion history exposes retryable Storage cleanup'],
  ...
  [/method: 'DELETE'[\s\S]*confirmation: deleteConfirmation[\s\S]*Type \{deleteExp\.code\} to confirm/, 'Expression deletion requires exact code confirmation'],
