...
const checks = [
  ...
  [/COT AI does not reveal passwords/, 'COT AI explains protected-information boundaries'],
  [/immediate danger[\s\S]*authorised pastoral care/, 'COT AI explains urgent-safety escalation'],
