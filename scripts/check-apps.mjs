...
const checks = [
  ...
  [/Report content[\s\S]*Spam or misleading[\s\S]*Harassment or abuse[\s\S]*Privacy or personal information[\s\S]*Submit report/, 'member reporting uses one compact reusable safety sheet'],
  ...
  [/onReport\?: \(\) => void[\s\S]*accessibilityLabel="Report reel"[\s\S]*onReport=\{\(\) => handleReportReel\(item\)\}/, 'Reels expose member reporting in the immersive action rail'],
