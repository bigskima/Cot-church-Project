...
const checks = [
  ...
  [/ScripturePreviewCard[\s\S]*detectScriptureReferences[\s\S]*Request pastoral support/, 'COT AI renders Scripture previews and member-controlled pastoral support'],
  [/COT AI does not reveal passwords[\s\S]*immediate danger[\s\S]*authorised pastoral care/, 'COT AI explains privacy and urgent-safety escalation to members'],
  [/Care & AI Alerts[\s\S]*user_username[\s\S]*last_member_message/, 'pastoral triage surfaces scoped COT AI alerts with member identity and context'],
