...
const checks = [
  ...
  [/canPublishPublicReels[\s\S]*generalWorkspace && signedIn/, 'General Reel creation is available to every signed-in account'],
  ...
  [/canPublishPublicVideos[\s\S]*generalWorkspace && signedIn/, 'General Watch creation is available to every signed-in account'],
