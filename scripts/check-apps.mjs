...
const checks = [
  ...
  [/EXPRESSION OPERATIONS[\s\S]*key: 'tools'[\s\S]*key: 'studio'[\s\S]*key: 'live'[\s\S]*key: 'sermons'[\s\S]*key: 'events'[\s\S]*key: 'access'[\s\S]*key: 'settings'/, 'Expression operations header connects layered management destinations'],
