...
const presets: Preset[] = [
  ...
  { label: 'Cloudflare AI token', reference: 'CLOUDFLARE_AI_TOKEN', category: 'ai', providerCode: 'cloudflare', description: 'Cloudflare Workers AI token used for COT Daily visual generation', helper: 'Paste a Cloudflare API token with Workers AI access for the target account.' },
  { label: 'YouVersion Bible app key', reference: 'BIBLE_YOUVERSION_APP_KEY', category: 'integration', providerCode: 'youversion', description: 'YouVersion publisher app key used for licensed Bible translations', helper: 'Paste the YouVersion App Key exactly as issued to the COT publisher account.' },
  { label: 'Bible Brain API key', reference: 'BIBLE_BRAIN_API_KEY', category: 'integration', providerCode: 'bible_brain', description: 'Bible Brain API key used for optional recorded Bible audio', helper: 'Paste the Bible Brain API key exactly as issued.' },
  { label: 'Cloudflare account ID', reference: 'CLOUDFLARE_ACCOUNT_ID', category: 'ai', providerCode: 'cloudflare', description: 'Cloudflare account ID used by the COT Daily visual image adapter', helper: 'Paste the Cloudflare Account ID shown in your Cloudflare dashboard. It is stored in the protected provider vault with the image-generation configuration.' },
  { label: 'YouTube Data API key', reference: 'STREAMING_YOUTUBE_DATA_API', category: 'streaming', providerCode: 'youtube', description: 'API key used to discover the configured General COT YouTube livestream', helper: 'Paste the Google/YouTube Data API key. The public Channel ID is configured on Streaming Services.' },
  { label: 'Agora RTC credentials', reference: 'STREAMING_AGORA_PRIMARY', category: 'streaming', providerCode: 'agora', description: 'Agora App ID and App Certificate used to issue Expression livestream tokens', helper: 'Use JSON: {"appId":"...","appCertificate":"..."}' },
