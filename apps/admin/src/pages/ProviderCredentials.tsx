...
const presets: Preset[] = [
  ...
  { label: 'YouVersion Bible app key', reference: 'BIBLE_YOUVERSION_APP_KEY', category: 'bible', providerCode: 'youversion', description: 'YouVersion publisher app key used for licensed Bible translations', helper: 'Paste the YouVersion App Key exactly as issued to the COT publisher account.' },
  { label: 'Bible Brain API key', reference: 'BIBLE_BRAIN_API_KEY', category: 'bible', providerCode: 'bible_brain', description: 'Bible Brain API key used for optional recorded Bible audio', helper: 'Paste the Bible Brain API key exactly as issued.' },
