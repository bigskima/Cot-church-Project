...
export default function GeneralMinistryWorkspace() {
  ...
  const tools = useMemo<Tool[]>(() => [
    ...
    { key: 'sermons', title: 'Pastor’s Messages', description: 'Create, manage and publish church-wide pastoral audio and video messages.', icon: 'book-outline', route: '/general/leadership/sermons-manage', area: 'Content', badge: 'MESSAGES', enabled: access.canManagePastorMessages, priority: true },
