...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 19, lineHeight: 24, fontWeight: '850', letterSpacing: -0.35 },
  ...
  countText: { fontSize: 11, fontWeight: '850' },
  ...
  replyingKicker: { fontSize: 9, fontWeight: '850', textTransform: 'uppercase', letterSpacing: 0.5 },
  replyingName: { fontSize: 11, fontWeight: '750', marginTop: 1 },
  ...
  signInText: { flex: 1, fontSize: 12, fontWeight: '750' },
  ...
  errorText: { flex: 1, fontSize: 11, lineHeight: 15, fontWeight: '650' },
