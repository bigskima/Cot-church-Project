...
export default function LeadershipHubScreen() {
  ...
  const tools = [
    ...
    { title: 'Watch Categories', description: 'Rename, search, reorder or hide the video categories people see in Watch.', iconName: 'pricetags-outline', badge: 'MEDIA', route: '/general/leadership/watch-categories', enabled: canManageWatchCategories },
    ...
    { title: 'Church Profile', description: 'Manage Our Story, Quick Facts, church location and Our Leaders in one place.', iconName: 'business-outline', badge: 'CHURCH', route: '/general/church-story?manage=1', enabled: canManageChurchLeadership },
    ...
    { title: 'Home banners', description: 'Manage the rotating General COT Home spotlight and its destinations.', iconName: 'images-outline', badge: 'SPOTLIGHT', route: '/general/leadership/home-banners', enabled: generalWorkspace && (hasOrganizationCapability('announcements.manage') || canManageEvents) },
    { title: 'Forms & Responses', description: 'Build configurable forms and manage member responses.', iconName: 'document-text-outline', badge: 'FORMS', route: '/general/leadership/forms-manage', enabled: generalWorkspace && (hasOrganizationCapability('announcements.manage') || canManageEvents) },
