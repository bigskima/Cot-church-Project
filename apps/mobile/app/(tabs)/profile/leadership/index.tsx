...
export default function LeadershipHubScreen() {
  ...
  const tools = [
    ...
    { title: 'Expression Giving', description: 'Configure the selected Expression’s giving purposes and manual bank-transfer destinations.', iconName: 'gift-outline', badge: 'GIVING', route: '/(tabs)/profile/leadership/giving-manage', enabled: canManageGiving },
    ...
    { title: 'Expressions', description: 'View Expressions. Creation is separately protected by explicit Platform Authority creator authorization.', iconName: 'business-outline', badge: 'EXPRESSIONS', route: '/(tabs)/profile/leadership/expressions-manage', enabled: canManageExpressions },
  ];
