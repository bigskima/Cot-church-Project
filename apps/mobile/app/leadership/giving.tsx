...
import type { GivingCampaign } from '@/types/content';
    ...
    try {
      await api.request('giving', {
        ...
        body: JSON.stringify({
          ...
          goalAmountMinor: campaignGoal ? Math.round(parseFloat(campaignGoal) * 100) : null,
          status: 'active',
        }),
      });
      setCampaignName('');
          ...
          {activeTab === 'campaigns' ? (
            <>
              ...
              <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }, shadows.sm]}>
                ...
                <InputField
                  label="Target Goal Amount ($) (Optional)"
                  value={campaignGoal}
                ...
                <InputField
                  ...
                  onChangeText={setCampaignCurrency}
