  ...
  const tools = [
    {
      ...
      description: 'Create live broadcasts, retrieve RTMP ingest stream keys, and monitor stream health.',
    ...
    },
    {
      ...
      description: 'Manage confidential prayer petitions, respond to altar call decisions, and assign follow-ups.',
    ...
    },
    {
      ...
      description: 'Add, update, and manage local pastors, directors, coordinators, and public bios.',
    ...
    },
    {
      ...
      description: 'Administer church giving campaigns, building projects, and configure bank transfer instructions.',
    ...
    },
    {
      ...
      description: 'Review recorded message drafts, assign scripture topics, and publish sermons to members.',
    ...
    },
    {
      ...
      description: 'Schedule sanctuary worship gatherings, configure attendance caps, and manage event schedules.',
    ...
    },
    {
      ...
      description: 'Bootstrap new church campuses, daughter expressions, and establish local authority.',
