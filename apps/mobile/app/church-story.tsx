            ...
            hasStoryContent ? (
              <View style={styles.storySection}>
                ...
                {story.founding_story ? (
                  <View style={[styles.sectionCard, { backgroundColor: colors.card, borderColor: colors.border }, shadows.sm]}>
                    <Text style={[styles.cardKicker, { color: colors.interactive }]}>
                      FOUNDING HERITAGE {story.founding_year ? `(${story.founding_year})` : ''}
                    </Text>
              ...
              <EmptyState
                ...
                message="The church leadership has not published heritage information yet."
