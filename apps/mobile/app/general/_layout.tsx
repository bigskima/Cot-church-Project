...
export default function GeneralLayout() {
  ...
  useEffect(() => {
    ...
    void leaveExpression()
      .catch((value) => {
        if (!cancelled) {
          setBoundaryError(value instanceof Error ? value.message : 'Unable to open General COT.');
        }
      })
      .finally(() => {
        ...
        <View style={[styles.boundaryCard, { backgroundColor: colors.card, borderColor: colors.borderSubtle }]}>
          {boundaryError ? (
            ...
            <>
              ...
              <Text style={[styles.boundaryCopy, { color: colors.textSecondary }]}>
                Clearing the private Expression context before the church-wide experience is rendered.
              </Text>
            </>
          )}
        </View>
  ...
  return (
    <Tabs screenOptions={screenOptions} backBehavior="history">
      <Tabs.Screen
        ...
        options={{
          title: 'Home',
          tabBarAccessibilityLabel: 'General COT Home',
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Explore',
          tabBarAccessibilityLabel: 'Explore General COT',
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Community',
          tabBarAccessibilityLabel: 'General Community',
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'You',
          tabBarAccessibilityLabel: 'Your General COT profile',
